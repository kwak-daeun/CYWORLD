...
<body>
	<div class="main-container">
		...
		<div class="right-box">
			<h2>CYWORLD</h2>
				<form action='<c:url value="/user/login" />' method="post" name="frm"><!-- 로그인 정보를 확인하는 form 태그 -->
					<table>
			<tr>
				<!-- <td>아이디</td> --><!-- 아이디를 입력하는 텍스트 -->
				<td><input type="text" class="user-id" name="userid" value="${usrId}" placeholder="아이디" style="width : 250px;" ></td>
			</tr>
			<tr>
